...
inline const ::std::string& qUestion::n() const {
  // @@protoc_insertion_point(field_get:onlinejudge.qUestion.N)
  return n_.GetNoArena();
}
inline void qUestion::set_n(const ::std::string& value) {
  
  n_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:onlinejudge.qUestion.N)
}
#if LANG_CXX11
inline void qUestion::set_n(::std::string&& value) {
  
  n_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:onlinejudge.qUestion.N)
}
#endif
inline void qUestion::set_n(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  n_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:onlinejudge.qUestion.N)
}
inline void qUestion::set_n(const char* value, size_t size) {
  
  n_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:onlinejudge.qUestion.N)
}
inline ::std::string* qUestion::mutable_n() {
...
inline ::std::string* qUestion::release_n() {
...
inline void qUestion::set_allocated_n(::std::string* n) {
  if (n != NULL) {
...
inline const ::std::string& qSubmit::n() const {
  // @@protoc_insertion_point(field_get:onlinejudge.qSubmit.N)
  return n_.GetNoArena();
}
inline void qSubmit::set_n(const ::std::string& value) {
  
  n_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:onlinejudge.qSubmit.N)
}
#if LANG_CXX11
inline void qSubmit::set_n(::std::string&& value) {
  
  n_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:onlinejudge.qSubmit.N)
}
#endif
inline void qSubmit::set_n(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  
  n_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:onlinejudge.qSubmit.N)
}
inline void qSubmit::set_n(const char* value, size_t size) {
  
  n_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:onlinejudge.qSubmit.N)
}
inline ::std::string* qSubmit::mutable_n() {
  
  // @@protoc_insertion_point(field_mutable:onlinejudge.qSubmit.N)
  return n_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* qSubmit::release_n() {
  // @@protoc_insertion_point(field_release:onlinejudge.qSubmit.N)
  
  return n_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void qSubmit::set_allocated_n(::std::string* n) {
  if (n != NULL) {
